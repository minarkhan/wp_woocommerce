...
WP Popup Builder is a powerful tool to create amazing popup for your site. Its drag and drop feature help to create form in very easy step without having knowledge of coding. Popup builder comes with five drag & drop modules ( Heading, Text, Form, Button and Image ).
...
1. Upload the `wp-popup-builder.zip` to the `/wp-content/plugins/` directory
...
== Screenshots ==
1. Drag & Drop Modules
2. Live Editor & Styling
3. Background Styling
4. Popup Timer visibility
...
= 1.1.1 =
* dashbaord new style added.
= 1.1.0 =
* new dashbaord style added.
* popup reload feature added.
* new demo view added.
* module issue fixed.

= 1.0.9 =
* styling issue fixed.
* Layout images chnaged.
...
= 1.0.6 =
* issue fixed and new images added.

= 1.0.5 =
* pribult popup issue fixed.

= 1.0.4 =
* new prebuilt popup added.
* style issue fix.
* responsive issue fixed.
* live editor issue fix.


= 1.0.3 =
* Image issue fix.
* Popup Responsive issue fix.
* style issue fix.
...
Thanks for using our plugin, I am sure you will create a great popup for your site. If you have any query then you can contact at our forum : http://www.themehunk.com/support
